...
include 'connect_db.php';
        ...
        if( !empty($_POST['colorname'])  )
    {
        ...
        $colorname =$_POST["colorname"];
            ...
            //insert 
			$sql ="INSERT INTO color( ColorName) VALUES ('$colorname')";	
    ...
    <body>
        ...
        <div style="display: flex; flex-direction: row; margin-top: 70px;">
            <div class="navigate__admin">
                ...
                <a href="addcolor.php"><div style="border-right: 5px solid #ffd503;">thêm màu sản phẩm</div></a>
            ...
            <div class="messages">
            	...
            	<table>
            		...
            		$stt=1;
            		 while($row = $result->fetch_assoc()){
            		 	echo "<tr><td>".$stt++."</td><td>".$row['ColorName'].
            		 	"</td></tr>";
            		 }
                ...
                <form action="addcolor.php" method="post" enctype="multipart/form-data">

                <label for="mau">Màu</label>
                <input type="text" id="mau" name="colorname" >
